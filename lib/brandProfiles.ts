...
export const BRAND_PROFILES: Record<string, BrandProfile> = {
  ...
  kitchenblockers: { platform: "UpPromote", platformUrl: "https://af.uppromote.com/kitchenblockers/login", commissionPct: 0.4, code: "KITCHEN", discount: "15% off", storeLink: "https://kitchenblockers.com?sca_ref=12331241.hfJz9sateb", connected: "Connected" },

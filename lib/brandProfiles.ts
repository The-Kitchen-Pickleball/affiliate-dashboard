...
export const BRAND_PROFILES: Record<string, BrandProfile> = {
  ...
  diadem: { platform: "UpPromote", platformUrl: "https://af.uppromote.com/diademsports/login", commissionPct: 0.15, code: "KITCHEN", discount: "10% off", storeLink: "https://diademsports.com?sca_ref=9835156.lrczGA9BQJRwKSi", connected: "Connected" },
  ...
  "goaffpro-forwrd": { platform: "GoAffPro", platformUrl: "https://forwrd.goaffpro.com/login", commissionPct: 0.15, code: "KITCHEN", discount: "5% off", storeLink: "https://forwrd.co/?ref=eixrxnja", connected: "Connected" },
  ...
  kitchenblockers: { platform: "UpPromote", platformUrl: "https://af.uppromote.com/kitchenblockers/login", commissionPct: 0.4, code: "KITCHEN", discount: "10% off", storeLink: "https://kitchenblockers.com?sca_ref=12331241.hfJz9sateb", connected: "Connected" },
